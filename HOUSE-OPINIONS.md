...
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| 2026-08-12 | Test naming `UnitOfWork_Scenario_ExpectedBehavior` + explicit Arrange/Act/Assert comments                                           | [opinions/testing.md](opinions/testing.md) (retrofitted — predates this file)                                                                                        | Owner      |
