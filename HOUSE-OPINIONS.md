...
| 2026-08-12 | Warnings are always treated as errors (not CI-only); any suppression carries an inline comment explaining why | [opinions/ci.md](opinions/ci.md), [templates/Directory.Build.props](templates/Directory.Build.props) | Owner      |
