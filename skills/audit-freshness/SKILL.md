...
| `research/` topics with `status: open`                                                     | 90 days — then reported as promote-or-discard triage, resolved with `resolve-research`; one left on disk after promotion is itself a finding (promotion ends in deletion)                                         |
